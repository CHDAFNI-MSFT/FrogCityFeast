...
const STRUCTURAL_LIMITS := {
	...
	"belly_overlay": {
		"game_nodes": BASE_GAME_NODES + 256,
		"collision_objects": 41,
		"collision_shapes": 111,
		"targets": MAX_TARGETS,
	...
	"generated_streaming": {
		"game_nodes": BASE_GAME_NODES + 210,
