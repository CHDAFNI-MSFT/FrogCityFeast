...
const MAX_TARGETS := 33
const MAX_BUILDINGS := 4
const MAX_INTERIOR_ROOMS := 7
...
const STRUCTURAL_LIMITS := {
	...
	"generated_streaming": {
		"game_nodes": 541,
		"collision_objects": 97,
		"collision_shapes": 148,
